...
import userSix from '../images/user/Ellipse 1.png';
import { Link } from 'react-router-dom';

const Developer = () => {
  return (
    <>
      <Breadcrumb pageName="About Developer" />
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Ui/Ux Designer & Fullstack Engineer</p>
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-102 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                Hey there! I'm Willicent Mbuguaa, a software engineering student at ALX deeply passionate about UI/UX design and full-stack development. At Corium Connect, I harness my skills in React, Vue.js, Node.js, and Python to architect seamless, user-centric solutions. With a meticulous eye for detail, I craft pixel-perfect interfaces and scalable backend systems that merge elegance with functionality. Beyond coding, I'm an avid learner immersed in the latest tech trends, from AI to blockchain. Let's collaborate on pushing boundaries and shaping the future of tech together!
              </p>
            </div>
