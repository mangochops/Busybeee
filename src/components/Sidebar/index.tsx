...
import Logo from '../../images/logo/Group 1.png';
import { MdTrendingUp, MdLink, MdCampaign, MdReceipt, MdBarChart} from 'react-icons/md';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('statistics') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <MdBarChart className="h-6 w-6 text-current" />
                  Analytics
                </NavLink>
              </li>
              ...
              <li>
                <NavLink
                  to="/trends"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('trends') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <MdTrendingUp className="h-6 w-6 text-current" />
                  Trends
                </NavLink>
              </li>
              {/* <!-- Menu Item Linked Accounts --> */}
              <li>
                <NavLink
                  to="/Linked Accounts"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('linked-accounts') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <MdLink className="h-6 w-6 text-current" />
                  Linked Accounts
                </NavLink>
              </li>
                   
              {/* <!-- Menu Item Advertising --> */}
              <li>
                <NavLink
                  to="/advertisements"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('advertisements') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <MdCampaign className="h-6 w-6 text-current" />
                  Advertisements
                </NavLink>
              </li>
              {/* <!-- Menu Item Billing --> */}
              <li>
                <NavLink
                  to="/billing"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('billing') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <MdReceipt className="h-6 w-6 text-current" />
                  Billing
                </NavLink>
              </li>
              ...
              <li>
                ...
                >
                  <IoInformationCircleOutline className="text-gray-500" size={24} />
                  About
                </NavLink>
              </li>
            </ul>
